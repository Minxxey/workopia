<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-nav-link url="/jobs/saved" :active="request()->is('/obs/saved')">
                Saved Jobs
            </x-nav-link>
            ...
            <x-button-link url="/dashboard" icon="gauge">Dashboard</x-button-link>
        </nav>
        <button
            id="hamburger"
    ...
    >
        ...
        <x-button-link url="/dashboard" icon="gauge" :block="true">Dashboard</x-button-link>
    </nav>
</header>
